...
public class Level4Controller {
    ...
    void initialize()
    {
        ...
        FadeTransition ft3 = new FadeTransition(Duration.millis(3500), playerImage);
        ...
        FadeTransition ft4 = new FadeTransition(Duration.millis(3500), opponentImage);
