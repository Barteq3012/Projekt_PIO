...
public class AllCard {
    ...
    public static void createCards() {
        ...
        Card flameArmor = new Card("Flame Armor", 2, 2, 1, 10, Card.cardType.Fire, "/pictures/ognista_zbroja.png", 0);
        ...
        allCard.add(sword);
        Card axe = new Card("Axe", 11, 1, 15, 0, Card.cardType.Weapon, "/pictures/topór.png", -5);
        allCard.add(axe);
        Card bow = new Card("Bow", 12, 1, 7, 0, Card.cardType.Weapon, "/pictures/łuk.png", 0);
        allCard.add(bow);
        Card arrow = new Card("Arrow", 13, 1, 5, 0, Card.cardType.Weapon, "/pictures/strzała.png", 0);
        allCard.add(arrow);
        ...
        allCard.add(charon);
        Card timeOfLifeAndDeath = new Card("Time of life and death",30,2,10,0, Card.cardType.Magic,"/pictures/pora_życia_i_śmierci.png",10);
